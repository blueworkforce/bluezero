...
B0_EXPORT void b0_node_init(b0_node *node);
B0_EXPORT void b0_node_shutdown(b0_node *node);
B0_EXPORT int b0_node_shutdown_requested(b0_node *node);
B0_EXPORT void b0_node_spin_once(b0_node *node);
B0_EXPORT void b0_node_spin(b0_node *node);
B0_EXPORT void b0_node_cleanup(b0_node *node);
...
B0_EXPORT void b0_node_log(b0_node *node, int level, const char *message);
...
B0_EXPORT void b0_publisher_init(b0_publisher *pub);
B0_EXPORT void b0_publisher_cleanup(b0_publisher *pub);
B0_EXPORT void b0_publisher_spin_once(b0_publisher *pub);
B0_EXPORT const char * b0_publisher_get_topic_name(b0_publisher *pub);
B0_EXPORT void b0_publisher_publish(b0_publisher *pub, const void *data, size_t size);
B0_EXPORT void b0_publisher_log(b0_publisher *pub, int level, const char *message);
B0_EXPORT void b0_publisher_set_option(b0_publisher *pub, int option, int value);
...
B0_EXPORT void b0_subscriber_init(b0_subscriber *sub);
B0_EXPORT void b0_subscriber_cleanup(b0_subscriber *sub);
B0_EXPORT void b0_subscriber_spin_once(b0_subscriber *sub);
B0_EXPORT const char * b0_subscriber_get_topic_name(b0_subscriber *sub);
B0_EXPORT void b0_subscriber_log(b0_subscriber *sub, int level, const char *message);
...
B0_EXPORT void b0_subscriber_set_option(b0_subscriber *sub, int option, int value);
...
B0_EXPORT void b0_service_client_init(b0_service_client *cli);
B0_EXPORT void b0_service_client_cleanup(b0_service_client *cli);
B0_EXPORT void b0_service_client_spin_once(b0_service_client *cli);
...
B0_EXPORT void b0_service_client_log(b0_service_client *cli, int level, const char *message);
B0_EXPORT void b0_service_client_set_option(b0_service_client *cli, int option, int value);
...
B0_EXPORT void b0_service_server_init(b0_service_server *srv);
B0_EXPORT void b0_service_server_cleanup(b0_service_server *srv);
B0_EXPORT void b0_service_server_spin_once(b0_service_server *srv);
B0_EXPORT const char * b0_service_server_get_service_name(b0_service_server *srv);
B0_EXPORT void b0_service_server_log(b0_service_server *srv, int level, const char *message);
...
B0_EXPORT void b0_service_server_write(b0_service_server *srv, const void *msg, size_t size);
B0_EXPORT void b0_service_server_set_option(b0_service_server *srv, int option, int value);
